...
export const CATALOG: ProviderCatalogEntry[] = [
...

  {
    ...
    supports_chat: false,
    icon: '🟢',
    notes: 'OAuth flow not available in this build. Use OpenAI API instead.',
  },
  {
    id: 'claude_oauth',
    display_name: 'Claude',
    short_description: 'Connect via your Claude.ai account',
    category: 'subscription_oauth',
    auth_type: 'oauth',
    compatibility: 'not_implemented',
    status: 'not_available_in_this_build',
    ...
    supports_chat: false,
    icon: '🟠',
    notes: 'OAuth flow not available in this build. Use Anthropic API instead.',
  },
